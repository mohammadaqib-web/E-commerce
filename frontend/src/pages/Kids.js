...
function Kids() {
    ...
    const fetchData = async () => {
        try {
            ...
            // Filter products based on category (kids)
            const kidsProducts = allProducts.data.allProducts.filter(product => product.category === 'Kids');
    ...
    return (
        <div>
            ...
            <div className='container mt-3'>
                <h2 className='text-center text-decoration-underline text-light'>Kids</h2>
