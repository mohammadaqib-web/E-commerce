...
function Men() {
    ...
    const fetchData = async () => {
        try {
            ...
            // Filter products based on category(men)
            const menProducts = allProducts.data.allProducts.filter(product => product.category === 'Men');
    ...
    return (
        <div>
            ...
            <div className='container mt-3'>
                <h2 className='text-center text-decoration-underline text-light'>Men</h2>
